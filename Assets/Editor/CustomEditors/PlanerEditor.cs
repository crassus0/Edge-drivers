...
public class PlanerEditor : Editor
{
  void OnEnable()
  {
    ...
    {
      targetObject.transform.GetChild(i).hideFlags = 0;// HideFlags.HideInHierarchy | HideFlags.HideInInspector;
    }
  }
  public override void OnInspectorGUI()
  {
    ...
    for (int i = 0; i < numChildren; i++)
    {
      //targetObject.transform.GetChild(i).hideFlags=HideFlags.HideInHierarchy|.HideInInspector;
    }
